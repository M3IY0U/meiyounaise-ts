...
INSERT INTO "new_guilds" ("embed_spotify", "id", "join_chn", "join_msg", "leave_chn", "leave_msg", "repeat_msg") SELECT "embed_spotify", "id", "join_chn", "join_msg", "leave_chn", "leave_msg", "repeat_msg" FROM "guilds";
DROP TABLE "guilds";
